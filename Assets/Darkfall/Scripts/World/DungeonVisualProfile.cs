            ...
            switch (chapter % 5)
            {
                case 1:
                    return Create(chapter, "ember-vaults", "ОБГОРЕВШИЕ ХРАНИЛИЩА",
                        ...
                        new Color(1f, .78f, .62f), new[] { 1, 5, 6, 9 }, new[] { 8, 10, 4 }, 2, 1.12f);
                case 2:
                    return Create(chapter, "drowned-crypt", "ЗАТОПЛЕННАЯ КРИПТА",
                        ...
                        new Color(.67f, .82f, .80f), new[] { 0, 3, 7, 11 }, new[] { 4, 8, 10 }, 3, 1.2f);
                case 3:
                    return Create(chapter, "charnel-gardens", "ТЛЕННЫЕ САДЫ",
                        ...
                        new Color(.68f, .80f, .55f), new[] { 0, 3, 5, 7, 11 }, new[] { 1, 4, 8 }, 3, 1.38f);
                case 4:
                    return Create(chapter, "obsidian-sanctum", "ОБСИДИАНОВЫЙ САНКТУМ",
                        ...
                        new Color(.76f, .65f, .88f), new[] { 1, 6, 9, 10 }, new[] { 4, 8, 10 }, 2, 1.22f);
                default:
                    return Create(chapter, "ashen-catacombs", "ПЕПЕЛЬНЫЕ КАТАКОМБЫ",
                        ...
                        Color.white, new[] { 4, 5, 6, 7 }, new[] { 0, 1, 8, 10 }, 2, 1f);
            }
        }
